...
namespace DevFreela.Payments.API.Consumers
{
    public class ProcessPaymentConsumer : BackgroundService
    {
        ...
        private readonly IConnection _connection; // Criar conexão para inicializar, e ficará escutando a mensagem e processando o evento.
        private readonly IModel _channel; // Armazena a sessão/canal
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            consumer.Received += (sender, eventArgs) =>
            {
                ...
                // Tell to broker that the message was received
